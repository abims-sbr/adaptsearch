...
def main():
    ...
    # read sequences 
    #   - without "-", for coutings
    #   - with "-", for transitions
    #   - with "-", for resampling (not always the same species than the ones for transitions)
    ...
    for pair in pairs_list:
        ...
        if (p1, p2) not in index_transi and p1 in sequences_for_counts and p2 in sequences_for_counts:
            ...
            all_aa_transitions[p1+">"+p2+"_freqs"] = aa_transitions_freqs
            all_aatypes_transitions[p1+">"+p2+"_freqs"] = aatypes_transitions_freqs
